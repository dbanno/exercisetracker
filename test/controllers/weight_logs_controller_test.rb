...
class WeightLogsControllerTest < ActionController::TestCase
  ...
  test "should create weight_log" do
    assert_difference('WeightLog.count') do
      post :create, weight_log: { exercise: @weight_log.exercise, reps: @weight_log.reps, weight: @weight_log.weight }
    end
  ...
  test "should update weight_log" do
    patch :update, id: @weight_log, weight_log: { exercise: @weight_log.exercise, reps: @weight_log.reps, weight: @weight_log.weight }
    assert_redirected_to weight_log_path(assigns(:weight_log))
  end
